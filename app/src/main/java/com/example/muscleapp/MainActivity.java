...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main), (v, insets) -> {
            ...
            v.setPadding(systemBars.left, systemBars.top, systemBars.right, 0); // Bottom padding handled by BottomNav if needed, but here we want content to be behind it or above it.
            return insets;
        });
